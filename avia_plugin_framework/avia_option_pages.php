<?php
##################################################################
class avia_option_pages_plugin_helper{
##################################################################
	...
	//constructor
	function avia_option_pages_plugin_helper($options, $pageinfo)
	{	
	...
	{	
		echo '<link rel="stylesheet" href="'. AVIA_FEEDBACK_BOX_URL_HELPER . 'avia_backend.css" type="text/css" />';
		/* echo '<script type="text/javascript" src="'.AVIA_FEEDBACK_BOX_URL_HELPER.'avia_backend_scripts.js"></script>'; */
	}
	
	function enqueue_head()
	{
		/*
wp_enqueue_script('kriesi_custom_fields_js', AVIA_FEEDBACK_BOX_URL_HELPER . 'avia_custom_fields.js');
...
*/
	...
	function make_data_available()
	{
		...
		$this->saved_optionname = $this->pageinfo['optionname'];
